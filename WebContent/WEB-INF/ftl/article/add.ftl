...
<div class="wrap">
   ...
   <div id="post_action" class="cle clearfix">
       <a id="bt_sub" href="javascript:void(0);" class="btn_post">发表文章</a>
       <ul class="post_condition">
           <li>
               <label><input type="checkbox" name="sendMsg" id="sendMsg" value="true" checked="">回复时给我消息</label>
               <span class="gray">[完成后可按 Ctrl+Enter 发布]</span>
           </li>
       </ul>
   </div>
</div>
