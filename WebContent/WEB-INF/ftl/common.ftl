    ...
    <div class="mini-main">
        ...
        <ul class="top-login">
        	<#if user??>
        		<li>您好！</li>
            	<li>|</li>
            	<li><a target="_blank" href="${bbs_url}xpabc/userCenter/mine/1.htm">${user.user_name}</a></li>
            <#else>
            	<li><a target="_blank" href="${bbs_url}xpabc/user/toLogin">登录</a></li>
            	<li>|</li>
            	<li><a target="_blank" href="${bbs_url}xpabc/user/toRegister.htm">注册</a></li>
        	</#if>
        </ul>
    </div>
</div>
<div class="header">
    <div class="header-main">
        <div class="clearfix">
            <div class="logo"><a href="${bbs_url}xpabc/index/index.htm"><img src="${bbs_url}images/logo.jpg" title="小胖爱编程" alt="小胖爱编程" style="width: 95%;"></a></div>
           <div class="nav">
	     <div class="nav-link">
                <ul>
...
<div class="header">
    <div class="header-main">
        <div class="clearfix">
            <div class="logo"><a href="${bbs_url}xpabc/index/index.htm" target="_blank"><img src="${bbs_url}images/logo.jpg" title="中国汽车消费网" alt="中国汽车消费网" style="width: 95%;"/></a></div>
           <div class="nav">
	     <div class="nav-link">
                <ul>
                    <li><a href="${bbs_url}xpabc/index/learnindex.htm">学习交流</a></li>
...
<div class="header">
    <div class="header-main">
        <div class="clearfix">
            <div class="logo"><a href="${bbs_url}xpabc/index/index.htm"><img src="${bbs_url}images/logo.jpg" title="小胖爱编程" alt="小胖爱编程" style="width:200px;"/></a></div>
           <div class="nav">
	     <div class="nav-link">
                <ul>
                    <li><a href="${bbs_url}xpabc/index/learnindex.htm">学习交流</a></li>
    ...
    <div id="nav" class='pageinfo'>
        ...
        <div class="fr search-box">
            <div class="fl" style="line-height:0">
                    <form target="_blank" method="get" id="searchForm" action="${bbs_url}xpabc/search/toSearch" >
...
<#macro html_js>
<!-- JavaScript codes -->
<script src="${bbs_url}js/jquery-1.11.2.min.js"></script>
<script src="${bbs_url}js/focus.js"></script>
<script src="${bbs_url}js/gjr.js"></script>
<script src="${bbs_url}js/bbsgis.js"></script>
<script src="${bbs_url}js/jquery.bxslider.min.js"></script>
<script>
    $(document).ready(function(){
...
<#macro html_user_left  type=0>
	<div class="US-left fl">
        ...
        <div class="US-info">
            <ul class="clearfix">
                <li><a href="${bbs_url}xpabc/userCenter/mine/1.htm"><img src="<#if user??&&user.user_photo??&&user.user_photo!="">${bbs_img}${user.user_photo}<#else>${bbs_url}images/36325340_120x120.jpg</#if>" height="70" width="70" alt=""></a></li>  
