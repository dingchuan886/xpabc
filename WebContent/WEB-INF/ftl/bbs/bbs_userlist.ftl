                ...
                <div class="box-bd">
                    <div class="pic-txt">
                        <a href="#" target="_blank">
                            <img src="${bbs_img!}${userphoto!}" style="width:70px;height:70px" class="logo-img"/>
                        </a>
...
<div class="forum_pages s_clear">
        <span class="page_back" id="page_back_bottom"><a href="javascript:toPage(1,${plateid},${userid})">返回首页</a></span>
        <div class="pager">
           <#list 1..pages as p> 
