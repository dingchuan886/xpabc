...
<div class="pd-20">
	<div class="text-l">
		...
		<input type="text" class="input-text" style="width:250px" placeholder="输入管理员名称" id="select_username" name="username" value="${username!""}">
...
function search(){
	...
	location.href = '${bbs_url}xpabc/admin/user/show.htm?role='+role+'&state='+state+'&username='+username;
}
function toPage(page){
	var username = "${username!""}";
	var role = ${role!-1};
	var state = ${state!-1};
	location.href = '${bbs_url}xpabc/admin/user/show.htm?role='+role+'&state='+state+'&username='+username+'&page='+page;
}
</script>
</@cc.html_foot>
